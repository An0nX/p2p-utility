"""
Configuration class for P2P Utility app.
...
class Config:
    ...
    This class provides configuration values for the application. The values
    are loaded from environment variables using the `python-dotenv` library.
